...
void menu()
{
	...
	do {
		...
		switch (count)
		{
		case 1: system("cls"), Writedown_E(employer), system("cls"), menu(); break;
		case 2: system("cls"), Writedown_W(worker), system("cls"), menu(); break;
		case 3: system("cls"), search(employer, worker, number), system("cls"), menu();  break;
		case 4: system("cls"), Output_E(employer), system("cls"), menu(); break;
		case 5: system("cls"), Output_W(worker), system("cls"), menu(); break;
		case 6: system("cls"), Output_D(number), system("cls"), menu(); break;
		case 7: system("cls"), File_E(employer), system("cls"), menu();  break;
		case 8: system("cls"), File_W(worker), system("cls"), menu();  break;
		case 9: system("cls"), deleteE(employer), system("cls"), menu(); break;
		case 10: system("cls"), deleteW(worker), system("cls"), menu(); break;
		case 11: break;
		}
	} while (count != 11);
}
